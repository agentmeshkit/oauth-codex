...
This directory is the source of truth for `@agentmeshkit/oauth-codex`.

## Component scope

- Responsibility: Codex OAuth credentials and ChatGPT backend client utilities.
- Registry: GitHub Packages.
- Current consumer: AgentWeb backend.
